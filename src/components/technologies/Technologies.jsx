...
export default function Technologies() {
  return (
    <section className="technology container container--pall" id="technologies">
      <div className="technology__content">
        <h2 className="technology__topic">Technologies</h2>
        <section className="technology__cards">
          <div className="technology__card">
            ...
            <h3 className="technology__topic">TypeScript</h3>
          ...
          <div className="technology__card">
            ...
            <h3 className="technology__topic">Mobx</h3>
          ...
          <div className="technology__card">
            ...
            <h3 className="technology__topic">Trello</h3>
          ...
          <div className="technology__card">
            ...
            <h3 className="technology__topic">Git</h3>
          ...
          <div className="technology__card">
            ...
            <h3 className="technology__topic">Ruby on Rails</h3>
          ...
          <div className="technology__card">
            ...
            <h3 className="technology__topic">Grape</h3>
